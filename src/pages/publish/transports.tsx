...
const Transports = () => {
  ...
  const onSubmit = async (data: FormInput) => {
    ...
    const sscc_numbers = data.sscc_numbers.replace(/ /g, "").split(",");
  ...
  return (
    <section>
      <Heading>Transport Publish Interface</Heading>
      <form onSubmit={handleSubmit(onSubmit)}>
        <FormHeading>Transport Details</FormHeading>
        <Span>List the logistics and transport unit you wish to aggregate</Span>
        <Label>Logistic IDs (E.g: "1,2,3")</Label>
        <Input
          type="text"
          name="sscc_numbers"
          ref={register}
        ...
        <Input type="text" name="giai" ref={register} placeholder="1" />
